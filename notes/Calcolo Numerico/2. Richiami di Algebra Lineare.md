...
Data una matrice $A \in \mathbb{C}^{m\times n}$  indichiamo con $\sigma_{i}$ i suoi valori singolari. Se indichiamo con $a_{i}$ gli $n$ autovalori di $AA^H$, vale la relazione
