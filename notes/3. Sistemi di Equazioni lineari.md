...
##### 3.9 Stima dell'errore reale del metodo iterativo
...
##### 3.10 Metodi iterativi per la risoluzione di sistemi lineari
...
##### 3.11 Metodi di Jacobi e Gauss-Seidel
...
##### 3.14 Metodo del gradiente coniugato chad
